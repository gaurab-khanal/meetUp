        ...
        <main className="container mx-auto px-4 py-16">
          ...
          <section className="flex flex-col-reverse md:flex-row items-center justify-between gap-12 mb-24">
            <div className="flex-1">
              ...
              >
                Create a room, share the link, and start chatting in seconds. No
                downloads, no accounts, just seamless peer-to-peer video calls.
              </motion.p>
              <motion.div
              ...
              {[
                {
                  ...
                  description:
                    "No downloads or sign-ups required. Create a room and start chatting immediately.",
                },
                {
                  icon: <Users className="h-10 w-10 text-blue-600" />,
                  title: "Peer-to-Peer",
                  description:
                    "Direct connection between participants for better privacy and lower latency.",
                },
                {
                  icon: <Share2 className="h-10 w-10 text-blue-600" />,
                  title: "Easy Sharing",
                  description:
                    "Share your room ID with anyone to invite them to your video call.",
                },
              ].map((feature, index) => (
                <motion.div
                  key={index}
                  ...
                  viewport={{ once: true }}
                >
                  <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 inline-block rounded-lg">
                    {feature.icon}
                  </div>
          ...
          >
            <h2 className="text-3xl font-bold mb-6">
              Ready to start your video chat?
            </h2>
            <p className="text-xl text-slate-600 dark:text-slate-300 mb-8 max-w-2xl mx-auto">
              No registration, no downloads. Just create a room and share the
              link.
            </p>
            <Link href="/room?create=true">
